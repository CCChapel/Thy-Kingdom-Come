...
class Logo extends React.Component {
    render() {
        ...
        return React.createElement(
            ...
            React.createElement('path', { className: 'cls-1', d: 'M1022,471.28v-2l-7.86,4.28,1.65-.09C1020.93,473.19,1022,472.46,1022,471.28Z' }),
            React.createElement('polygon', { points: '1013.02 473.63 1012.66 474.34 1014.05 473.57 1013.02 473.63' }),
            React.createElement('path', { d: 'M1146.08,544.53l-.15.59,3.38.73a13.52,13.52,0,0,1,2.55.74l12.43-6.86Z' }),
            React.createElement('path', { className: 'cls-1', d: 'M1135.58,667.83c-8.07,0-14.83,9.39-16.59,19.23l28.18-.29C1147.18,677.38,1144.25,667.83,1135.58,667.83Z' }),
            ...
            React.createElement('line', { className: 'cls-4', x1: '154.18', y1: '544.72', x2: '994.37', y2: '81.4' }),
...
class MinistryPartnerRow extends React.Component {
    ...
    render() {
        return React.createElement(
            "div",
            {
                className: "[ one-third ] [ bg-light-blue ] [ text-bigger cursor-point ] [ add-bottom-margin add-padding ] [ fx-bottom-border fx-dark-blue ]",
...
class Page extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                Section,
                { className: "bg-clouds bg-cover justify-content-center" },
