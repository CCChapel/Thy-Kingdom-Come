...
class /**
    ...
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'line',
                { id: 'line-top-left', className: 'cls-4', x1: '154.18', y1: '544.72', x2: '994.37', y2: '81.4' },
                React.createElement('animate', { attributeName: 'x1', attributeType: 'XML', from: '154.18', to: '164.18', begin: '0ms', dur: '600ms', repeatCount: 'indefinite' }),
                React.createElement('animate', { attributeName: 'y1', attributeType: 'XML', from: '544.72', to: '554.72', begin: '0ms', dur: '600ms', repeatCount: 'indefinite' }),
                React.createElement('animate', { attributeName: 'x2', attributeType: 'XML', from: '994.37', to: '1004.37', begin: '0ms', dur: '600ms', repeatCount: 'indefinite' }),
                React.createElement('animate', { attributeName: 'y2', attributeType: 'XML', from: '81.4', to: '91.4', begin: '0ms', dur: '600ms', repeatCount: 'indefinite' }),
                React.createElement('animate', { attributeName: 'x1', attributeType: 'XML', from: '164.18', to: '154.18', begin: '600ms', dur: '1200ms', repeatCount: 'indefinite' }),
                React.createElement('animate', { attributeName: 'y1', attributeType: 'XML', from: '554.72', to: '544.72', begin: '600ms', dur: '1200ms', repeatCount: 'indefinite' }),
                React.createElement('animate', { attributeName: 'x2', attributeType: 'XML', from: '1004.37', to: '994.37', begin: '600ms', dur: '1200ms', repeatCount: 'indefinite' }),
                React.createElement('animate', { attributeName: 'y2', attributeType: 'XML', from: '91.4', to: '81.4', begin: '600ms', dur: '1200ms', repeatCount: 'indefinite' })
            ),
            React.createElement('line', { className: 'cls-2', x1: '606.03', y1: '547.87', x2: '1270.03', y2: '181.72' }),
            React.createElement('line', { className: 'cls-5', x1: '753.18', y1: '466.73', x2: '1085.18', y2: '283.65' }),
            React.createElement('line', { className: 'cls-2', x1: '444.68', y1: '786.5', x2: '1447.92', y2: '233.28' }),
            React.createElement('line', { className: 'cls-2', x1: '1123.04', y1: '475.4', x2: '1486.49', y2: '274.98' }),
            React.createElement('line', { className: 'cls-3', x1: '624.04', y1: '836.32', x2: '1627.28', y2: '283.1' }),
            React.createElement('line', { className: 'cls-5', x1: '771.13', y1: '755.21', x2: '1249.22', y2: '491.58' }),
            React.createElement('line', { className: 'cls-2', x1: '614.81', y1: '920.4', x2: '851.48', y2: '789.89' }),
            React.createElement('line', { className: 'cls-2', x1: '808.39', y1: '893.22', x2: '1555.71', y2: '481.12' }),
            React.createElement('line', { className: 'cls-2', x1: '1388.15', y1: '1001.06', x2: '1751.6', y2: '800.63' })
        );
    }
}
/**
